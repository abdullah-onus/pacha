...
import 'package:pacha/widgets/carousel_image/carousel_state.dart';
...
class CarouselSlider extends StatefulWidget {
  ...
  CarouselSlider.builder({required this.itemCount, required this.itemBuilder, required this.options, carouselController, Key? key})
      : items = null,
        _carouselController = carouselController ?? CarouselController() as CarouselControllerImpl,
        super(key: key);
  @override
...
class CarouselSliderState extends State<CarouselSlider> with TickerProviderStateMixin {
    ...
    return RawGestureDetector(
      gestures: {
        _MultipleGestureRecognizer:
            GestureRecognizerFactoryWithHandlers<_MultipleGestureRecognizer>(() => _MultipleGestureRecognizer(), (_MultipleGestureRecognizer instance) {
          instance.onStart = (_) {
            onStart();
          };
          instance.onDown = (_) {
  ...
  Widget getEnlargeWrapper(Widget? child, {double? width, double? height, double? scale}) {
    ...
    return Transform.scale(scale: scale!, child: SizedBox(child: child, width: width, height: height));
  }
    ...
    return getGestureWrapper(PageView.builder(
      ...
      itemBuilder: (BuildContext context, int idx) {
        ...
        return AnimatedBuilder(
          ...
          child: (widget.items != null) ? (widget.items!.isNotEmpty ? widget.items![index] : Container()) : widget.itemBuilder!(context, index, idx),
